#!/usr/bin/env python3
"""EBR-IV reproducibility verifier.

One-command audit of the repro_ebr4/ package. Run from the repro_ebr4/ directory:
...
def build_manifest():
    ...
    for p in ["paper/ebr4_v0.tex", "paper/ebr4_v0.pdf"]:
        if os.path.exists(p):
